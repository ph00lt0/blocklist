...
### NextDNS
Unfortunately NextDNS does not offer this blocklist, you can however add the blocklist to NextDNS using [nextdnsctl
](https://github.com/danielmeint/nextdnsctl) which leverages the API to add the list. Install and authenticate the pip client and run:
